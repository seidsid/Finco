...
/**
 * Base class for All JFrame which will be used in Framework.FinCo Application
 *
...
public abstract class BaseMainJFrame extends JFrame {
    ...
    private final JButton btnCreateAcc = new JButton("Add Account");
    ...
    protected void setBtnAddAccLabel(String label) {
        btnCreateAcc.setText(label);
    }

    protected void setBtnWithdrawLabel(String label) {
        btnWithdraw.setText(label);
    }

    protected void setBtnGenerateReport(String label) {
        btnGenerateReport.setText(label);
    }
