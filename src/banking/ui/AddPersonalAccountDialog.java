...
public class AddPersonalAccountDialog extends BaseDialog {
    ...
    public AddPersonalAccountDialog(OkSubmitDelegate delegate, String title) {
    ...
    protected void btnOkActionPerformed() {
        delegate.onSubmitClicked(Arrays.asList(textFieldName.getText(), textFieldEmail.getText(), textFieldAccNo.getText(),
                ...
                textFieldDOB.getText(), UiUtilities.getInstance().getSelectedButtonText(btnAccTypeGroup)));
    }
