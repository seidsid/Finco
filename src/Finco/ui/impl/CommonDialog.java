...
public abstract class CommonDialog<T> extends BaseDialog<T> {
    ...
    public Optional<List<Component>> addToTOp() {
        return Optional.of(List.of(addNameLayout(),addEmailLayout(),addAccNoLayout(),addStreetLayout(),addCityLayout(),addStateLayout(),addZipLayout()));
    }
    ...
    protected String getAccountNumberText(){
        return textFieldAccNo.getText();
    }
    protected String getStreetText(){
